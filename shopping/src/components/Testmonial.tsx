...
<div className='bg-red-600 bg-[url(/cta-banner.avif)] bg-cover h-[700px] rounded-2xl grid place-items-center'>
...
<button className='bg-blackish text-white p-2 rounded-md'>25% DISCOUNT</button>        
 ...
 <p className='text-gray-500 text-[200px]'>Starting @ $20 <b>Shop Now</b></p>
    </div>
</div>
